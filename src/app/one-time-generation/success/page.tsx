...
function PaymentVerification() {
  ...
  if (isLoading) {
    return <Lead>Verifying your payment...</Lead>
  }
  ...
  return (
    <>
      ...
      <Lead className="mt-6">
        Thank you for your purchase. Your ISO 9001 documentation package is
        being prepared.
      </Lead>
      <div className="mt-8 space-y-4">
        <p className="text-sm text-gray-600">
          You will receive an email with your documentation package within the
          next 24 hours.
        </p>
        <p className="text-sm text-gray-600">
