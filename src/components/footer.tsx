...
function SocialLinks() {
  return (
    <>
      <Link
        href="https://facebook.com/contourna"
        target="_blank"
      ...
      <Link
        href="https://instagram.com/contourna"
        target="_blank"
      ...
      <Link
        href="https://github.com/contourna"
        target="_blank"
...
function Copyright() {
  return (
    <div className="text-sm/6 text-gray-950">
      &copy; {new Date().getFullYear()} Contourna Inc. All rights reserved.
    </div>
  )
}
